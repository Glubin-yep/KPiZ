...
import com.example.kpiz.adaptors.TodoAdapter
import com.example.kpiz.database.TodoDatabase
import com.example.kpiz.databinding.ActivityMainBinding
import com.example.kpiz.models.Task_Models
import com.example.kpiz.models.TodoViewModel
...
class MainActivity : AppCompatActivity(), TodoAdapter.TodoClickListener {
        ...
        val getContent =
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                if (result.resultCode == RESULT_OK) {
                    val todo = result.data?.getSerializableExtra("todo") as? Task_Models
                    if (todo != null) {
    ...
    override fun onItemClicked(todo: Task_Models) {
